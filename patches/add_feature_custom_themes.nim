...
// Optional per-theme `duration` (e.g. "2s") overrides the default speed for
// whichever animation this theme uses; validated so a malformed value can't
// break the generated CSS rule, falling back to the stock per-type default.
var __cdb_spinDurRaw=__cdb_spinnerSpec&&__cdb_spinnerSpec.duration;
var __cdb_spinDurOk=typeof __cdb_spinDurRaw==="string"&&/^\d+(\.\d+)?m?s$/.test(__cdb_spinDurRaw);
var __cdb_durSpin=__cdb_spinDurOk?__cdb_spinDurRaw:"1s";
var __cdb_durBounce=__cdb_spinDurOk?__cdb_spinDurRaw:".8s";
var __cdb_durPulse=__cdb_spinDurOk?__cdb_spinDurRaw:"1.2s";
...
__cdb_css+="svg[data-cdb-spinner].cdb-anim-flare path:nth-child("+(__cdb_ri+2)+"){animation:cdbRayRetract "+__cdb_rayTimings[__cdb_ri][0]+" ease-in-out infinite;animation-delay:"+__cdb_rayTimings[__cdb_ri][1]+";transform-box:view-box;transform-origin:50px 50px}";
}
